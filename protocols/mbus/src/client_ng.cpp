...
async::result<Result<Entity>> Instance::createEntity(std::string_view name, const Properties &properties) {
	...
	co_return Entity{connection_, resp.id()};
}
...
async::result<Result<void>> Entity::serveRemoteLane(helix::UniqueLane lane) const {
