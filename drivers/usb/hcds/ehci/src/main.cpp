...
async::result<void> Controller::probeDevice() {
	...
	[] (auto self, auto address, mbus_ng::Entity entity) -> async::detached {
		while (true) {
...
async::result<frg::expected<proto::UsbError>> Controller::_directTransfer(proto::ControlTransfer info,
